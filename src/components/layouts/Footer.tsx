...
import { Facebook, Twitter, Instagram, Youtube, Mail, MapPin, Phone, Apple } from "lucide-react"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          <div>
            ...
            <p className="text-background/80 mb-6">
              Delivering the freshest seasonal fruits from across Bangladesh straight to your doorstep.
            </p>
            <div className="flex gap-4">
              <Button size="icon" variant="ghost" className="h-9 w-9 rounded-full bg-background/10 hover:bg-background/20">
                <Facebook size={18} />
              </Button>
              <Button size="icon" variant="ghost" className="h-9 w-9 rounded-full bg-background/10 hover:bg-background/20">
                <Twitter size={18} />
