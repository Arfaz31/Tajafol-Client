...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-yellow-50 ">
      ...
      <div className="relative  bg-gradient-to-r from-green-600 to-yellow-600 text-white pt-20 pb-10">
        <div className="absolute inset-0 bg-black/20"></div>
        <div className="container mx-auto px-4 xl:py-20 lg:py-14 py-10 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              চাঁপাইনবাবগঞ্জের সেরা আম, রসালো লিচু ও তাজা ফলের জন্য আমাদের সাথে
              যোগাযোগ করুন।
              <br />
              <span className="text-yellow-200">
                ২৪/৭ গ্রাহক সেবা । দ্রুত ডেলিভারি । ১০০% গুণগত মান
              </span>
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-green-100">
                ঢাকায় ২৪ ঘন্টা, সারাদেশে ৩-৫ দিন
              </p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-green-100">
                যেকোনো সমস্যায় আমরা আছি আপনার পাশে
              </p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-green-100">
                ৬৪ জেলায় আমাদের ডেলিভারি নেটওয়ার্ক
              </p>
            </div>
          </div>
        </motion.div>
        ...
        {/* Business Hours & Info */}
        <div className="grid grid-cols-1 gap-4 sm:gap-6 md:gap-8 mb-8 sm:mb-12 md:mb-16 px-4 sm:px-6 md:px-8">
          <motion.div
          ...
          >
            <div className="flex items-center mb-4 sm:mb-6">
              <Clock className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-green-600 mr-2 sm:mr-3" />
            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                <h3 className="font-semibold text-base sm:text-lg mb-2 sm:mb-3 text-green-700">
                  অর্ডার ও ডেলিভারি
                </h3>
              ...
              <div>
                <h3 className="font-semibold text-base sm:text-lg mb-2 sm:mb-3 text-blue-700">
                  কাস্টমার সার্ভিস
                </h3>
                <ul className="space-y-1 sm:space-y-2 text-gray-600 text-sm sm:text-base">
                  <li className="flex justify-between">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="p-3 sm:p-4 bg-blue-50 rounded-xl border border-blue-200">
                ...
                <p className="text-xs sm:text-sm text-blue-600">
                  *Facebook এ মেসেজ পাঠান
                </p>
              </div>
              <div className="p-3 sm:p-4 bg-orange-50 rounded-xl border border-orange-200">
                <h3 className="font-semibold text-orange-800 mb-1 sm:mb-2 text-sm sm:text-base">
                  ফোন কল
                </h3>
              ...
              <div className="bg-gray-100 rounded-xl h-[400px] flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 font-medium">
                    গুগল ম্যাপ এখানে সংযুক্ত হবে
                  </p>
                  <p className="text-sm text-gray-400 mt-2">
                    জিপিএস: ২ৃ.৭৯৩৬°N, ৯০.৪০৫৮°E
                  </p>
                </div>
              </div>
            </div>
        ...
        <motion.div
          ...
          className="mt-16 bg-gradient-to-br from-gray-50 to-green-50 rounded-2xl p-4"
        >
          <h2 className="text-2xl font-bold mb-6 text-center text-gray-800 pt-4">
            সচরাচর জিজ্ঞাসা
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-4">
            <div className="space-y-4">
              <div className="bg-white p-4 rounded-xl shadow-sm">
                <h3 className="font-semibold text-green-700 mb-2">
                  অর্ডার করতে কি কি লাগবে?
                </h3>
                <p className="text-gray-600 text-sm">
                  শুধু আপনার মোবাইল নম্বর ও ঠিকানা দিন। আমরা বাকি সব দেখে নেব।
                </p>
              </div>
              <div className="bg-white p-4 rounded-xl shadow-sm">
                <h3 className="font-semibold text-green-700 mb-2">
                ...
                <p className="text-gray-600 text-sm">
                  ক্যাশ অন ডেলিভারি, বিকাশ, নগদ, রকেট - সব পদ্ধতিতে পেমেন্ট করতে
                  পারবেন।
                </p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="bg-white p-4 rounded-xl shadow-sm">
                ...
                <p className="text-gray-600 text-sm">
                  ঢাকায় ২৪ ঘন্টা, অন্যান্য জেলায় ৩-৫ কার্যদিবস।
                </p>
              </div>
              <div className="bg-white p-4 rounded-xl shadow-sm">
                <h3 className="font-semibold text-green-700 mb-2">
                ...
                <p className="text-gray-600 text-sm">
                  ১০০% রিপ্লেসমেন্ট গ্যারান্টি। ডেলিভারির ২৪ ঘন্টার মধ্যে জানান।
                </p>
              </div>
            </div>
          </div>
