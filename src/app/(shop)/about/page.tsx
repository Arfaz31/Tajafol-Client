...
import banner from "@/assets/aboutimage/about-hero.jpg";
import about from "@/assets/aboutimage/about-2.jpeg";
      ...
      <div className="relative h-[70vh]  overflow-hidden ">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4 relative z-10">
            ...
            >
              বাংলাদেশের আম রাজধানী চাঁপাইনবাবগঞ্জ থেকে সরাসরি আপনার দোরগোড়ায়
              <br />
              <span className="text-yellow-300 font-semibold">
                সতেজ, খাঁটি ও প্রাকৃতিক ফলের নিশ্চয়তা
              </span>
            </motion.p>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        ...
        >
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
              <p>
                চাঁপাইনবাবগঞ্জ - বাংলাদেশের আম রাজধানী, যেখানে শতাব্দীর পর
                শতাব্দী ধরে চাষ হয়ে আসছে বিশ্বের সেরা আম। এই অঞ্চলে রয়েছে ২৭০+
                জাতের আম, যার মধ্যে খিরসাপাত, গোপালভোগ, লাংড়া, ফজলী অন্যতম।
              </p>
              <p>
                টাজাফল প্রতিষ্ঠিত হয়েছে ২০২৩ সালে একটি সহজ লক্ষ্য নিয়ে -
                চাঁপাইনবাবগঞ্জের ৩৭,৫৮৮ হেক্টর জমির ২৮,২৬,০০০ আম গাছ থেকে সরাসরি
                কৃষকদের কাছ থেকে সর্বোচ্চ মানের ফল সংগ্রহ করে সারাদেশের মানুষের
                কাছে পৌঁছে দেওয়া।
              </p>
              <p>
                কানসাট আম বাজার - বাংলাদেশের সবচেয়ে আইকনিক আম বাজার এবং
                স্থানীয় চাষীদের সাথে আমাদের দৃঢ় সম্পর্ক আমাদের পণ্যের গুণমান
                নিশ্চিত করে।
              </p>
            </div>
          </div>
        ...
        >
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            চাঁপাইনবাবগঞ্জের ঐতিহ্যবাহী আম থেকে শুরু করে সারাদেশের সেরা ফল - সবই
            পাবেন টাজাফলে। আমাদের সাথে যুক্ত হন এবং প্রকৃতির সেরা উপহার উপভোগ
            করুন।
          </p>
