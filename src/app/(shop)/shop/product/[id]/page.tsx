                ...
                <div className="mb-6">
                  {product.discountedPrice ? (
                    <div className="flex items-baseline gap-2">
                      <span className="text-3xl font-bold text-primary">৳{product.discountedPrice}</span>
              ...
              <div className="prose max-w-none">
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-background rounded-lg p-5">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2">
                        <span className="h-5 w-5 rounded-full bg-secondary/20 text-secondary flex items-center justify-center text-xs mt-0.5">⚑</span>
                        <span>Store in a cool, dry place at room temperature</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="h-5 w-5 rounded-full bg-secondary/20 text-secondary flex items-center justify-center text-xs mt-0.5">⚑</span>
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <div className="h-2 bg-primary/20 rounded-full overflow-hidden">
                            <div 
                              ...
                              style={{ width: `${Math.min(100, (product.nutritionFacts.calories / 800) * 100)}%` }}
                            />
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="h-2 bg-primary/20 rounded-full overflow-hidden">
                            <div 
                              className="h-full bg-primary rounded-full" 
                              style={{ width: `${Math.min(100, (product.nutritionFacts.carbs / 30) * 100)}%` }}
                            />
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="h-2 bg-secondary/20 rounded-full overflow-hidden">
                            <div 
                              ...
                              style={{ width: `${Math.min(100, (product.nutritionFacts.protein / 5) * 100)}%` }}
                            />
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="h-2 bg-accent/20 rounded-full overflow-hidden">
                            <div 
                              ...
                              style={{ width: `${Math.min(100, (product.nutritionFacts.fat / 3) * 100)}%` }}
                            />
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="h-2 bg-secondary/20 rounded-full overflow-hidden">
                            <div 
                              className="h-full bg-secondary rounded-full" 
                              style={{ width: `${Math.min(100, (product.nutritionFacts.fiber / 5) * 100)}%` }}
                            />
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="h-2 bg-accent/20 rounded-full overflow-hidden">
                            <div 
                              className="h-full bg-accent rounded-full" 
                              style={{ width: `${Math.min(100, (product.nutritionFacts.sugar / 20) * 100)}%` }}
                            />
                          </div>
                        </div>
                      </div>
                        ...
                        {product.nutritionFacts.vitamins.map((vitamin, index) => (
                          <div key={index}>
                            ...
                            <div className="h-2 bg-primary/20 rounded-full overflow-hidden">
                              <div 
                                className="h-full bg-primary rounded-full" 
                                style={{ width: `${Math.min(100, vitamin.percentage)}%` }}
                              />
                            </div>
                          </div>
                        ))}
                      ...
                      <div className="mt-6 pt-4 border-t border-border">
                        ...
                        <ul className="space-y-2">
                          <li className="flex items-start gap-2">
                            ...
                            <span className="text-sm">Rich in essential vitamins and minerals</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <Leaf className="h-4 w-4 text-secondary mt-0.5" />
              ...
              <div className="flex flex-col md:flex-row gap-8">
                <div className="md:w-1/3 bg-background p-6 rounded-lg">
                  <div className="text-center mb-6">
                    <h3 className="text-3xl font-bold mb-1">{product.rating}/5</h3>
                    ...
                    {[
                      {
                        ...
                        rating: 5,
                        date: "March 25, 2025",
                        comment: "These mangoes are incredibly sweet and juicy. The quality is consistent every time I order. Highly recommended!",
                        helpful: 12
                      },
                      {
                        name: "Fazlur R.",
                        rating: 4,
                        date: "March 22, 2025",
                        comment: "Great quality fruit, arrived fresh and well-packaged. Only reason for 4 stars is that one of them was slightly bruised, but overall very good.",
                        helpful: 7
                      },
                      {
                        name: "Moushumi A.",
                        rating: 5,
                        date: "March 18, 2025",
                        comment: "Absolutely love these fruits! The taste is so much better than what I find in local markets. Will definitely order again.",
                        helpful: 9
                      }
                    ].map((review, index) => (
