...
const BillingAddressForm: React.FC<BillingAddressFormProps> = ({
  ...
  // Handle toggle between dropdown and custom input
  const toggleCustomDivision = () => {
    setUseCustomDivision(!useCustomDivision);
    if (!useCustomDivision) {
      // When switching to custom input, clear the division value
      setValue("division", "");
  ...
  const toggleCustomDistrict = () => {
    setUseCustomDistrict(!useCustomDistrict);
    if (!useCustomDistrict) {
      // When switching to custom input, clear the district value
      setValue("district", "");
      // Also clear dependent field
      setValue("upazila", "");
      setUseCustomUpazila(true);
    }
  };

  const toggleCustomUpazila = () => {
    setUseCustomUpazila(!useCustomUpazila);
    if (!useCustomUpazila) {
      // When switching to custom input, clear the upazila value
      setValue("upazila", "");
    }
  };
